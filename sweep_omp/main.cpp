...
void ompSweep(int equationCount,double* subDiagonal, double* mainDiagonal, double* supDiagonal,
...
//    serialSweep(gridSize, subDiagonal, mainDiagonal, supDiagonal, f, p);
    ompSweep(gridSize, subDiagonal, mainDiagonal, supDiagonal, f, THREAD_COUNT, p);
